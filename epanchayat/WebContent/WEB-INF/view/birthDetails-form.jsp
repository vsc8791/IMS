		...
		<form:form action="saveBirthDetails" modelAttribute="birthDetails"
			...
			<table align="center">
				<tbody>
					...
					<tr>
						<td><label>Mother's Addhaar Details:</label></td>
						<td><form:input path="madhaar" type="number"/></td>
					</tr>
					<tr>
						<td><label>Mother's Nationality:</label></td>
						<td><form:input path="mothernationality"/></td>
					</tr>
					<tr>
						<td><label>Mother's Age:</label></td>
						<td><form:input path="mage" type="number"/></td>
					</tr>
					<tr>
